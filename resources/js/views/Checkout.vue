        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="order-box">
                    ...
                    <p class="small-text text-muted float-left">{{product.price}}đ</p>
                    <p class="small-text text-muted float-right">Số lượng tối đà: {{product.units}}</p>
                    <br>
                    <hr>
                    <label class="row"><span class="col-md-2 float-left">Số lượng: </span><input type="number" name="units" min="1" :max="product.units" class="col-md-2 float-left" v-model="quantity" @change="checkUnits"></label>
                </div>
                <br>
                <div>
                    <div v-if="!isLoggedIn">
                        ...
                        <button class="col-md-4 btn btn-danger float-right" @click="register">Tạo tài khoản</button>
                    </div>
                    <div v-if="isLoggedIn">
                        <div class="row">
